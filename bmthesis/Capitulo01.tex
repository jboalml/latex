...
Una vez instalado todo esto, se puede abrir la plantilla a través del archivo con extensión \texttt{\small .tcp}, que es un proyecto de TeXnicCenter. Si ha instalado otro compilador, tenga en cuenta que el documento principal es \texttt{\small ProyectoFinCarrera.tex}. 
